...
func RouterPrompt(outgoingMessagesQueueName string) string {
	prompt := `Você é o classificador de intenções e roteador do S5N.
	...
	- Use "target_queue": "` + outgoingMessagesQueueName + `"
